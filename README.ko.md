...
안녕하세요, 정희진입니다. 소프트웨어 엔지니어로서 배우며 성장하고 있습니다. 백엔드는 Java와 Spring Boot로 익혔고, 요즘은 웹 프런트엔드와 macOS 네이티브까지 스택을 넓히는 중입니다. 오픈소스에도 조금씩 기여하고 있습니다.
...
**[🪞 time-mirror](https://github.com/kes02/time-mirror)** — 예상 계획과 실제 계획를 나란히 놓고 보는 타임라인 플래너(PWA). 세운 계획대로 하루를 보냈는지 되돌아봅니다.
`TypeScript` · `PWA`
